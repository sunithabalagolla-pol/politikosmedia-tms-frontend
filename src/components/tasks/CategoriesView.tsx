            ...
            >
              <div className="flex flex-col items-center text-center space-y-3">
                ...
                {category.logo_url ? (
                  ...
                  <Folder className="w-12 h-12 text-blue-500 group-hover:scale-110 transition-transform" />
                )}
                ...
                <div className="flex gap-3 text-xs text-gray-500 dark:text-gray-400 pt-2 border-t border-gray-100 dark:border-gray-700 w-full justify-center">
